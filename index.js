...
const client = makeWASocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["Sc Push Kontak Terbaru V11", "Dekstop", "3.0"]})
console.log(color('[ SC BY RizalXdxz ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : RizalXdzzBot\n➸ Creator : ZIRO\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : RIZAL XDZZ`\n➸ My Instagram : @RizalXdzz\n\nDonase Me For Support :\n➸ DONASI : Cet Admin\n\nThanks\n', 'pink'))
