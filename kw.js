...
*BOT WHATSAPP BY DAPZSTORE ✨*

      *⏤͟͟͞͞★ INFO - BOT ꗄ➺* 

*☍ Nama BOTz :* DapzStorezzz
*☍ Version BOTz :* v1.1.0
...
✅ WAJIB MENGGUNAKAN JASA ADMIN *RIZAL* SUPAYA TERHINDAR DARI PENIPUAN  !
✅ BE SMART BUYYER`
reply(teks938)
}
break
case "payment": {
teks137 = "*🔰PAYMENT DapzzStore⚡*\n```SEMUA PEMBAYARAN\nWAJIB MENYERTAKAN BUKTI TRANSFER !!```\n*_( ALL TRX NO REFF‼️ )_*\n\n*• GOPAY 💳 :* _08contohaja_\n```( ATAS NAMA: Nabilcontoh )```\n\n*• DANA 💳 :*```pm admin\n( ATAS NAMA: BilzCONTOHI )```\n\n*• OVO 💳 :*```pm.admin\n( ATAS NAMA: bilzContoh )```\n\n*• SHOPPE PAY 💳 :*```pm admin\n( ATAS NAMA: KOSONG )```\n\n*• QRIS 💳 :*https://telegra.ph/file/7c229092c67d2333d2493.jpg*\n```( ATAS NAMA: Ytta )```\n\n*© DapZzStore ⚡*"
reply(teks137)
}
break
case "donasi": {
...
⏣ ɢᴏᴘᴀʏ: [ pm admin ]
⏣ ᴛᴇʟᴋᴏᴍsᴇʟ:  [ pm admin ]
⏣ ǫʀɪs ᴀʟʟ ᴘᴀʏ : [ https://telegra.ph/file/7c229092c67d2333d2493.jpg ]

𝚃𝚛𝚒𝚖𝚊𝚔𝚊𝚜𝚒𝚑 𝙱𝚊𝚐𝚒 𝚈𝚐 𝙱𝚎𝚛𝚍𝚘𝚗𝚊𝚜𝚒 😁

⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘ ⌕
         ❨ *DapzZStore* ❩`
client.sendMessage(from, { image: { url: "https://telegra.ph/file/5d8195c357db740eb2057.jpg" }, caption: teks28 }, { quoted: msg })
}
break
case "sewa": {
teks91 = `◎ © Hay Kak @${sender.split("@")[0]}
Sewa Bot ? Hubungi Admin Untuk Nego Wa.me/6285279292140`
