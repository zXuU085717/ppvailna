...
const client = makeWaSocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC Simple By NabilZ-MD", "Dekstop", "3.0"]})
console.log(color('[ SC BY ZiroMD ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : BilZ-MD\n➸ Creator : BilZZ\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : Noname999`\n➸ My Instagram : @bilz_08z\n\nDonase Me For Support :\n➸ DONASI : https://saweria.co/ailnabotz\n\nThanks\n', 'red'))
